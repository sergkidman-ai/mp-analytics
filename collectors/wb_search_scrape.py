...
Регионы — только Москва (dest -1257786) до ответа Сергея на вопрос 2 из промта; дополнительные
dest передаются --dest вручную для проб.
...
DEFAULT_REGIONS = [(-1257786, "msk")]     # дополняется по ответу Сергея на вопрос 2 промта
PAUSE = 3.5
RETRIES = 3
