...
«Москва экспресс») — все под Цифровым, **подтверждено Сергеем 02.08.2026**. Появится Яндекс
у Дисквэра — заводить отдельный аккаунт `ya_acc2` в источнике, а не разносить кампании руками.
"""
