...
SUB = ('Данные из <b>витрины Яндекс.Маркета</b> (Партнёр-API: заказы + отчёт услуг + закрытие '
       ...
       'НАЧИСЛЕННЫМИ</b>, погашенная баллами часть — справочной строкой под итогом; на «Итого к '
...
FOOT = ('Все строки — из витрины <b>Яндекс.Маркета</b> (Партнёр-API). <b>Оборот</b> = Оплата '
        ...
        '<b>Строки удержаний — начисленные</b> (деньгами + зачёт), справочная строка «в т.ч. '
        'погашено баллами» показывает мост к деньгам. <b>«Субсидия по заказам» (subsidy)</b> — та же '
