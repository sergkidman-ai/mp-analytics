...
# имя серии/модели: латинские бренд-слова длиннее 6 букв (Photosmart, WorkCentre, LaserJet) НЕ обрезаем —
# {1,12}; кириллицу держим короткой {1,6}, чтобы не тащить русские слова целиком. Иначе fam_reply эхом
# отдавал обрезок («Photosmart 7760»→«osmart 7760», «WorkCentre 3210»→«Centre 3210»).
MODEL_RX = re.compile(r"(?:[A-Za-z]{1,12}|[А-Яа-я]{1,6})[- ]?\d{2,4}[A-Za-z0-9\-]*")
...
NEG_WB = ("Здравствуйте, {name}! Напишите нам, пожалуйста, в чат по QR-коду на упаковке или в товарном чеке внутри коробки "
