...
рейтингу карточки, а не по тексту отзыва.
  * рейтинг 4.0 и выше — негатив карточку НЕ убил → отвечает человек: карточку ещё спасаем,
    ответ читает будущий покупатель;
  * рейтинг ниже 4.0 — карточка под убой → сухой шаблон-хендофф в чат по QR,
...
ALIVE = 4.6          # ориентир «здоровой» карточки — от него считаем цену спасения
DEAD = 4.0           # порог Сергея 24.08.2026: рейтинг ниже 4 — карточка под убой
MAX_RESCUE = 10      # пятёрок подряд до ALIVE — справочно, на маршрут не влияет
