...
NAME_SUFFIX = {
    ...
    # `булат` увело бы её в `bt`. Аббревиатура не выдумана — взята из живой базы МС:
    # из 694 незаархивированных карточек с «7Q» 612 стоят на `q`, 58 на старом `bt`, 7 на `sq`.
    "bulat": [(r"\b7q\b", "q"), (r"grafit|графит", "gf"), (r"s-line", "sl"), (r"булат", "bt")],
}
