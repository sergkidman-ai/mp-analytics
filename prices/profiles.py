...
class Profile:
    ...
    price_min_rub: str = "1"      # дешевле — почти наверняка мусор в колонке
    price_max_rub: str = "500000"  # дороже — тоже
    jump_pct: str = "50"          # рост цены к прошлой загрузке, % — выше порога флаг
