...
MARK = "📥"
# ✅ ставится, когда поручение из записки выполнено и текст события заменён на результат
# (`biz_diary.resolve`). Правило Сергея 23.08.2026: в ленте не должно висеть задачи, по
# которой не видно, сделана она или нет, — поэтому «посмотри, что у нас на складе»
# превращается в «нашего товара там нет», а не соседствует с ним.
DONE_MARK = "✅"
