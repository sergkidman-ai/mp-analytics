...
отзывов“», «Для части ваших товаров подключили доупаковку», «Добавили ваши товары в акцию».
...
# --- правила важности -------------------------------------------------------------------
# ALERT — деньги: тариф, комиссия, договор, подписка, а также услуги и акции, которые
# ПОДКЛЮЧАЮТ САМИ и которые надо успеть отключить. Именно про них просила Наталья.
ALERT = [
    (r"тариф", "тарифы"),
    (r"комисси", "комиссии"),
    (r"договор", "договор"),
...
# По телу письма тревожим только там, где Ozon прячет факт подключения в текст.
...
BODY_ALERT = [
    ...
    (r"добавили\s+ваши\s+товары\s+в\s+акци", "автодобавление в акцию"),
]
