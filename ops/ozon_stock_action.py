...
Что делает:
  ...
  3. считает свою цену, а не потолок Ozon:
       пол   = (себест + max(300 ₽, 10 % себеста)) / доля выручки, что остаётся нам после удержаний;
...
GOAL_NET_PCT = 0.10                 # …или 10 % себестоимости, что больше. Правило ВБ-сторожа,
                                    # одно на обе площадки и на лестницу (решение Сергея 16.09.2026)
