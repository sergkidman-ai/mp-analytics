...
свой устаревший вердикт. Один и тот же приём лечит две разные болезни:
  ...
  W — «На доработку» (PARTIAL_APPROVED) с замечанием из белого списка HEAL_WARN: значение
      ...
      не потеряла ни одна. С 26.08.2026 в списке ещё cover_unprocessed (не обработалась
      видеообложка): карточка 0104 acc1 вылечилась повтором, замечание падает регулярно.
      Замечания «значения нет вовсе» (warning_attribute_values_empty,
