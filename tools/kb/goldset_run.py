#!/usr/bin/env python3
# поток: infra
"""CONTROL-прогон gold-set на ТЕКУЩЕЙ системе (до любых изменений MVP-1).
...
OUT = '/opt/mp-analytics/reports/data/goldset_control_2026-08-20'
...
def main():
    ...
    meta = {'generated': time.strftime('%Y-%m-%d %H:%M'), 'version': ver, 'model': MODEL,
            ...
            'memory': 'полный MEMORY.md скоупа репозитория, без изменений'}
