...
Признак — только слова «ориг.» / «оригинал» / «(о)» в названии. Метка OEM оригинал НЕ означает:
у КВК ТРЕЙД это обезличенная коробка поставщика, картридж внутри совместимый (поправка Сергея
18.08.2026), и суффикс кода `oem` у нас носят как раз такие карточки.
...
ORIGINAL_RE = re.compile(r"ориг(инал|\.)?|\(\s*[оО]\s*\)", re.I)
