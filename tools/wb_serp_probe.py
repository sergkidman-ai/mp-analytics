...
def main():
    ...
    # Про лимитер: жёсткие 429 после 30 запросов были на СТАРОМ хосте search.wb.ru. На
    # u-search.wb.ru замер 11.08 — 152 ключа подряд с паузой 2-4 с прошли без единого отказа.
    # Ночной крон ходит с --pause 3 6 (≈10 мин на 152 ключа); задирать до 30 60 больше не нужно.
