...
# 10.08.2026: Звёздные товары отключить НЕЛЬЗЯ (кабинет не отдаёт тумблер), их 1,5 п.п.
# из допущения убраны. Остаётся Premium Pro: факт июля 261 188 ₽ на оборот 10 310 785 ₽
# = 2,53 п.п., тариф заканчивается сам 23.08.2026. Берём 2,4 консервативно.
MARGIN_UP = 2.4
KPI = 25.0
