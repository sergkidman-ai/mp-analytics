...
# п.п. маржи, которые вернутся после отключения платных программ Ozon.
# Premium Pro: факт июля 261 188 ₽ на выручку 10 574 701 ₽ = 2,47 п.п., тариф кончается
# сам 23.08.2026 — учтён. Звёздные товары (159 900 ₽ = 1,51 п.п.) отключаемы, расчёт
# в docs/reports/ozon_stars_verdict.md говорит отключать, но пока тумблер не выключен
# в допущение их не берём. Выключите — поднимайте MARGIN_UP до 3,9.
MARGIN_UP = 2.4
KPI = 25.0
